...
final class SetupController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->render([
            ...
            'configuredClientId' => $settings?->get('telegram.client_id', (string) $this->config->get('telegram.client_id', '')) ?? '',
            'hasClientSecret' => trim((string) ($settings?->get('telegram.client_secret', (string) $this->config->get('telegram.client_secret', '')) ?? '')) !== '',
            'hasBotToken' => trim((string) ($settings?->get('telegram.bot_token', (string) $this->config->get('telegram.bot_token', '')) ?? '')) !== '',
            'adminChats' => $status['schema'] ? $this->effectiveList($settings, 'telegram.admin_chat_ids') : [],
            'bootstrapAdminIds' => $status['schema'] ? $this->effectiveList($settings, 'telegram.bootstrap_admin_telegram_ids') : [],
            'hasHolidayKey' => $status['schema']
                && trim((string) ($settings?->get('holiday_api.service_key', (string) $this->config->get('holiday_api.service_key', '')) ?? '')) !== '',
