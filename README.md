...
- 연차·반차·공가·병가·대체휴가 신청
- 입사일 등록 전 휴가 신청 차단
- 시작일 변경 시 종료일도 같은 날짜로 자동 맞춤
- 과거 날짜가 포함된 신청은 이전 미기록 휴가 여부 확인
- 오전/오후 반차 구분
- 월간 달력에서 본인 휴가 일정 확인
- 올해 월별 휴가 사용량 확인
...
- 휴가 승인·반려·승인 취소
- 승인/취소 입력은 목록이 아닌 확인 dialog에서 처리
- 취소·반려 휴가 기록 영구 정리 기능
- 직원 휴가 직접 등록 및 즉시 승인
- 전체 직원 월간 휴가 달력과 월별 집계 확인
- 주요 목록에서 10/20/50/100건 단위 페이징
- 관리자 대시보드에서 오늘 실제 휴가 중인 직원과 향후 14일 예정 휴가를 분리 확인
...
- **회사 공용 그룹**: 일반 승인 휴가 일정 등록 및 취소
- **관리자 직접 등록**: 즉시 승인하되 Telegram 알림은 전송하지 않음
