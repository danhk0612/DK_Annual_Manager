...
- **관리자 개인 메시지**: 휴가 신청, 신청 사유, 잔여 연차 경고
...
직원은 달력 또는 신청 화면에서 휴가를 등록합니다.

관리자는 Telegram 알림 또는 관리자 승인 화면에서 내용을 확인하고 승인·반려할 수 있습니다. 연차·반차는 승인 시 연차 원장에 자동 반영되며, 승인 취소 시 자동 복원됩니다.
